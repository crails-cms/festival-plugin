...
xxd -i -n festival_plugin_application_css lib/application.css lib/application.css.cpp
xxd -i -n festival_plugin_application_js lib/application.js lib/application.js.cpp
xxd -i -n festival_plugin_admin_js lib/admin.js lib/admin.js.cpp
##
## Database
##
odb \
